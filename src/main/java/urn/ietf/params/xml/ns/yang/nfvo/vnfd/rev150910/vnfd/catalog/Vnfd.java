...
import urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.VnfdCatalog;
 ...
 * 
 * <p>To create instances of this class use {@link urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.vnfd.catalog.VnfdBuilder}.
 * @see urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.vnfd.catalog.VnfdBuilder
 * @see urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.vnfd.catalog.VnfdKey
 *
 */
...
public interface Vnfd
    extends
    ChildOf<VnfdCatalog>,
    Augmentable<urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.vnfd.catalog.Vnfd>,
    VnfdDescriptor,
    Identifiable<VnfdKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfd.rev150910.vnfd.catalog.VnfdKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VnfdKey getKey();
