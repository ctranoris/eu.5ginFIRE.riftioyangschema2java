...
public class ParameterKey
 implements Identifier<Parameter> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev150423.initial.config.ParameterKey.class.getSimpleName()).append(" [");
        boolean first = true;
