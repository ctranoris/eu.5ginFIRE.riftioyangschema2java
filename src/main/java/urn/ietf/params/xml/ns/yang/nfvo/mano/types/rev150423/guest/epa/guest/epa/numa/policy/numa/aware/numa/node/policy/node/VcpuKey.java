...
public class VcpuKey
 implements Identifier<Vcpu> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev150423.guest.epa.guest.epa.numa.policy.numa.aware.numa.node.policy.node.VcpuKey.class.getSimpleName()).append(" [");
        boolean first = true;
