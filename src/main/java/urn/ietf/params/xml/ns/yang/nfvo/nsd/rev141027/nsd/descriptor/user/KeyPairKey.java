...
public class KeyPairKey
 implements Identifier<KeyPair> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(urn.ietf.params.xml.ns.yang.nfvo.nsd.rev141027.nsd.descriptor.user.KeyPairKey.class.getSimpleName()).append(" [");
        boolean first = true;
